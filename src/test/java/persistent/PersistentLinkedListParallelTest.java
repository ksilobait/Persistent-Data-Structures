...
public class PersistentLinkedListParallelTest {
    private final int positive = 10;
    private final int negative = 1;

    class T1 implements Runnable {

        private PersistentLinkedListParallel<Integer> data;

        public T1(PersistentLinkedListParallel<Integer> data) {
            this.data = data;
        }
        ...
        public void run() {
            for (int i = 0; i < 100; i++) {
                ...
                data.getLastAndAddLast(function);
    ...
    class T2 implements Runnable {
        ...
        public T2(PersistentLinkedListParallel<Integer> data) {
            this.data = data;
        }
    ...
    public void parallelTest() throws InterruptedException {
        PersistentLinkedListParallel<Integer> data = new PersistentLinkedListParallel<>(2);
        data.addLast(100);
        T1 t1 = new T1(data);
        T2 t2 = new T2(data);
